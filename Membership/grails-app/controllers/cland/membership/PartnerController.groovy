    ...
    def save(Partner partnerInstance) {
        ...
        request.withFormat {
            form multipartForm {
				...
				redirect (url:cbcApiService.getBasePath(request) + "partner/show/" + partnerInstance?.id, permanent:true)
            }
    ...
    def delete(Partner partnerInstance) {
        ...
        request.withFormat {
            form multipartForm {
				...
				redirect (url:cbcApiService.getBasePath(request) + "partner/", permanent:true)
            }
