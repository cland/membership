...
//]]>
	...
	<body>
		<div class="jumbotron">
			...
			<fieldset class="responsive-fieldset" style="background: #eee none repeat scroll 0% 0%;">
				<legend style="background:#fff;border: solid 2px rgb(248, 70, 70)">Register Form</legend>			
				

			<div class="wait hide row">Processing, please wait...</div>
			<div id="start-register" class="row" style="text-align:center;">
			...
			<div id="errors-div" class="errors hide row"></div>
						
			<div class="container" id="form-div" style="display:none;">
			...
			<div class="container" id="form-div-reset" style="display:none;">
				<div class="row text-center">					
					<div class="col-sm-12">
						<div id="errors-div-reset" class="errors hide"></div>
						<g:form id="resetclient_form" role="form" name="resetclient_form" onsubmit="return submitFormReset();" url="[controller:'self',action:'selfreset']">
									...
									<div class="form-group col-sm-4" id="group-finder-div">
										...
										<input class="form-control" style="border-color:rgba(8, 7, 7, 0.52);" id="person-email" name="resetemail" value="" placeholder="Email address">
									</div>
									<div class="form-group col-sm-4" style="margin-top:40px;" id="membershipno">
										...
										<input type="text" class="form-control" style="border-color:rgba(8, 7, 7, 0.52);" id="membership-no" name="membershipno" placeholder="Membership Number">
									</div>
									<div class="form-group col-sm-4" style="margin-top:40px;" id="captcha-group">
										<input type="text" class="is_realperson form-control" style="border-color:rgba(8, 7, 7, 0.52);" id="defaultReal" name="defaultReal" placeholder="Enter letters displayed above.">
								...
								<div class="" style="margin-top:20px;clear:both">
